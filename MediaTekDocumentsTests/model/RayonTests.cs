...
namespace MediaTekDocuments.model.Tests
{
     ...
     public class RayonTests
     {
          ...
          {
               NUnit.Framework.Assert.AreEqual(id, rayon.Id, "devrait réussir : id valorisé");
               NUnit.Framework.Assert.AreEqual(libelle, rayon.Libelle, "devrait réussir : libellé valorisé");
          }
     }
}
