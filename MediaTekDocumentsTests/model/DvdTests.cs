...
namespace MediaTekDocuments.model.Tests
{
     ...
     public class DvdTests
     {
          ...
          public void DvdTest()
          {
               NUnit.Framework.Assert.AreEqual(id, leDvd.Id, "devrait réussir : id valorisé");
               NUnit.Framework.Assert.AreEqual(titre, leDvd.Titre, "devrait réussir : titre valorisé");
               NUnit.Framework.Assert.AreEqual(image, leDvd.Image, "devrait réussir : image valorisée");
               NUnit.Framework.Assert.AreEqual(duree, leDvd.Duree, "devrait réussir : duree valorisée");
               NUnit.Framework.Assert.AreEqual(realisateur, leDvd.Realisateur, "devrait réussir : realisateur valorisé");
               NUnit.Framework.Assert.AreEqual(synopsis, leDvd.Synopsis, "devrait réussir : synopsis valorisé");
               NUnit.Framework.Assert.AreEqual(idGenre, leDvd.IdGenre, "devrait réussir : idGenre valorisé");
               NUnit.Framework.Assert.AreEqual(genre, leDvd.Genre, "devrait réussir : genre valorisé");
               NUnit.Framework.Assert.AreEqual(idPublic, leDvd.IdPublic, "devrait réussir : idPublic valorisé");
               NUnit.Framework.Assert.AreEqual(lePublic, leDvd.Public, "devrait réussir : public valorisé");
               NUnit.Framework.Assert.AreEqual(idRayon, leDvd.IdRayon, "devrait réussir : idRayon valorisé");
               NUnit.Framework.Assert.AreEqual(rayon, leDvd.Rayon, "devrait réussir : rayon valorisé");
          }
     }
}
